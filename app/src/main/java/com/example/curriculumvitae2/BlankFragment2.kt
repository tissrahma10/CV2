...
private var music: Boolean? = null
private var sport: Boolean? = null
private var games: Boolean? = null
...
class BlankFragment2 : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if(bundle!!.getBoolean("SPORTS1")){
                sport1!!.isChecked = true
            }
            if(bundle!!.getBoolean("GAMES1")){
    ...
    override fun onCreateView(
       ...
       // music =  bundle!!.getBoolean("MUSIC1")
      //  sport = bundle!!.getBoolean("SPORTS1")
     //   games = bundle!!.getBoolean("GAMES1")
